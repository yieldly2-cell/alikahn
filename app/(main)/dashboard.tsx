        ...
        {activeInvestments.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySubtext}>
              Make a deposit to start earning. After admin approval, your 72-hour timer begins automatically.
            </Text>
          </View>
        ) : (
...
const styles = StyleSheet.create({
  ...
  emptySubtext: { fontSize: 13, fontFamily: "DMSans_400Regular", color: Colors.dark.textMuted, marginTop: 4, textAlign: "center", paddingHorizontal: 20 },
});
